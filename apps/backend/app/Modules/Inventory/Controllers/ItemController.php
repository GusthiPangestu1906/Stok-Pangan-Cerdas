...
use App\Modules\Inventory\Actions\DeleteItemWithAuditAction;
...
class ItemController extends Controller
{
    ...
    /**
     * Remove the specified resource from storage and log food waste to Riwayat via Use Case.
     */
    public function destroy(Item $item, DeleteItemWithAuditAction $action)
    {
        $action->execute($item);
